...
from Conexion_BD import obtener_ecgs_por_paciente, eliminar_ecg_analizado
import pandas as pd
import io
import time
...
def historial_medico(pacientes_ordenados):
    ...
    # Estilos CSS personalizados (actualizados con los estilos del primer código)
    st.markdown("""
    <style>
        /* Estilos generales heredados del primer código */
        .historial-header {
            color: #2b5876;
        ...
        /* Nuevos estilos adaptados del primer código para los botones */
        .stButton > button {
        ...
        /* Estilo para el ícono del botón de eliminar */
                ...
                with st.container():
                    ...
                    with col3:
                        ...
                        if st.button("🗑", 
                                   ...
                                   on_click=lambda ecg_id=ecg['_id']: st.session_state.update({'to_delete': ecg_id})):
                            pass
